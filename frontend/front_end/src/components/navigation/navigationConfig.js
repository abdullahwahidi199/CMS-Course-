...
export const navigationModules = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Online Page", icon: Globe2, path: pathFor("online-page.view", "/admin/dashboard/online-page"), permission: "online-page.view" },
      { label: "Documentation", icon: CircleHelp, path: "/admin/dashboard/documentation" },
