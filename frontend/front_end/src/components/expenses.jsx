...
function Expenses() {
    ...
    const addNewExpense = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('could not add new Expense')
            }
        ...
        <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 mt-10 ">
                <div className="bg-green-100 p-4 rounded-lg shadow text-center">
                    ...
                    <p className="text-2xl font-bold text-green-800">{financialSummary.total_earnings} afs</p>
                </div>
                <div className="bg-red-100 p-4 rounded-lg shadow text-center">
                    <p className="text-sm text-red-700 font-semibold">Expenses</p>
                    <p className="text-2xl font-bold text-red-800">{financialSummary.total_expenses}</p>
                </div>
                <div className="bg-blue-100 p-4 rounded-lg shadow text-center">
                    <p className="text-sm text-blue-700 font-semibold">Remaining Balance</p>
                    <p className="text-2xl font-bold text-blue-800">{financialSummary.net_balance}</p>
                </div>
                    ...
                    <form
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col">
                                <label className="mb-1 text-sm font-medium text-gray-700">Expense Name</label>
                                <input
                                    type="text"
                                    name="name"
